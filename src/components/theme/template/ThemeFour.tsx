  ...
  return hasOverlay ? (
    ...
    <>
      ...
      >
        ...
        <section className=" flex flex-row justify-between items-center max-w-[1040px] mx-auto py-[44px] border-b border-b-raisin-black mb-10 px-6">
          <div className="flex flex-col gap-4 items-center">
            <p
              className={cn("text-2xl md:text-[40px]", inter.className)}
        ...
        <div className="flex flex-col">
          <section className="bg-fire-opal px-5 pt-5 relative order-2">
          ...
          <div className="relative container px-5 pt-[100px] pb-20 mx-auto max-w-desktop lg:px-20 xl:px-[100px] order-1">
            <div className="block md:hidden mb-12 md:mb-0 text-center">
              <h3 className="font-bold text-2xl mb-14">We’r Getting Married</h3>
              <h2
                className={cn(
                  "text-xl text-dark-liver mb-3",
                  allura.className
                )}
              >
                Assalamualaikum Warrohmatullah Wabarrakatuhu
              </h2>
              <p className="font-medium text-spanish-gray text-lg mb-8">
            ...
            <Image
              ...
              width={300}
              height={550}
              className="hidden lg:absolute -left-24 top-96 rotate-180"
            />
            ...
            <Image
              ...
              width={300}
              height={550}
              className="hidden lg:absolute w-24 md:w-[300px] bottom-0 right-0 md:-right-24 z-0"
            />
        ...
        <div className="container px-5 pt-[100px] pb-20 mx-auto max-w-desktop lg:px-20 xl:px-[100px]">
          <div className="max-w-[1040px] mx-auto mb-6 lg:mb-[335px]">
