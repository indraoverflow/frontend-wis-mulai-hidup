...
const CeremonyCard: React.FC<CeremonyCardProps> = ({
  ...
  return (
    <Card className="w-full overflow-hidden shadow-lg relative rounded-[30px]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-14">
          ...
          <div>
            <div className="text-center mb-4">
              <h3 className="text-3xl font-bold mb-3">{locationTitle}</h3>
              <p className="text-2xl font-light">{locationAddress}</p>
            </div>
            <Button
              variant="white"
              size="lg"
              className="border-0 w-full font-bold text-base"
            >
